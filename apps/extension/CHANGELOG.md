...
## [0.9.0](https://github.com/zenodeapp/namada-interface/compare/extension@v0.8.1...extension@v0.9.0) (2025-11-08)
...
* Keychain - Display chain name for known chains ([#1968](https://github.com/zenodeapp/namada-interface/issues/1968)) ([ab902e5](https://github.com/zenodeapp/namada-interface/commit/ab902e51564d24c238f1b7b0c0e6ad067decc9e5))
* Keychain - Increase session timeout from 5 to 30 minutes ([#2122](https://github.com/zenodeapp/namada-interface/issues/2122)) ([243c013](https://github.com/zenodeapp/namada-interface/commit/243c013356059cc7723b39ff2d60265b57b35cd1))
* Keychain signing - only require password on session timeout ([#1809](https://github.com/zenodeapp/namada-interface/issues/1809)) ([9050f64](https://github.com/zenodeapp/namada-interface/commit/9050f64d43125bc4b8c0f4faaee48dff473b3705))
...
* Mark Ledger accounts missing shielded account as outdated ([#2099](https://github.com/zenodeapp/namada-interface/issues/2099)) ([ddb2f5c](https://github.com/zenodeapp/namada-interface/commit/ddb2f5cb568a20a8dc94110ec81adf59d39e2f78))
...
* Update Keychain for new modified-zip32 ([#1624](https://github.com/zenodeapp/namada-interface/issues/1624)) ([b19caae](https://github.com/zenodeapp/namada-interface/commit/b19caae391b0411f51ee9b48325eeb62d421e7d3))
...
* Add forgot password section on Extension ([#1917](https://github.com/zenodeapp/namada-interface/issues/1917)) ([49a765b](https://github.com/zenodeapp/namada-interface/commit/49a765b82892c6a3c063028633b0cfa0ecbfb6ca))
...
* Extension sliced address ([#2169](https://github.com/zenodeapp/namada-interface/issues/2169)) ([901cdfa](https://github.com/zenodeapp/namada-interface/commit/901cdfaab5bf496537a69ee96cfe4fb7c69cb5a8))
* Keychain - Don't display approve connection form if already approved ([#1927](https://github.com/zenodeapp/namada-interface/issues/1927)) ([b234528](https://github.com/zenodeapp/namada-interface/commit/b234528c1c72d2dbd41ba59711e330449d69aec0))
* Pass proper path to deriveShieldedFromSeed ([#1690](https://github.com/zenodeapp/namada-interface/issues/1690)) ([7b94f9e](https://github.com/zenodeapp/namada-interface/commit/7b94f9e422a32620613f20b8fd349e630077a3fb))
...
* Update password checker when second input is used first ([#1921](https://github.com/zenodeapp/namada-interface/issues/1921)) ([949f325](https://github.com/zenodeapp/namada-interface/commit/949f3254cdc03c33be5875ac14f1e44dc4577e41))
* Use correct derivation path for masp signs using ledger AND sign all sapling inputs ([#2163](https://github.com/zenodeapp/namada-interface/issues/2163)) ([96539ed](https://github.com/zenodeapp/namada-interface/commit/96539ed2f9e06752e7cb595ab9029e5237c46c1b))
